...
/**
 * Simple user creation script for Docker
 * Usage: docker compose exec app node scripts/createuser-simple.js username email password role
 */
...
async function createUser() {
  try {
    ...
    if (!username || !email || !password) {
      console.log('Usage: node scripts/createuser-simple.js <username> <email> <password> [role]');
